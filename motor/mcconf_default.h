...
#define MCCONF_L_CURRENT_MAX			86.25	// Current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_CURRENT_MIN
#define MCCONF_L_CURRENT_MIN			-86.25	// Current limit in Amperes (Lower)
#endif
...
#define MCCONF_L_MIN_VOLTAGE			34.0		// Minimum input voltage
#endif
...
#define MCCONF_L_BATTERY_CUT_END		34.0		// Limit the positive current completely at this voltage
#endif
...
#define MCCONF_L_RPM_MAX				30000.0	// The motor speed limit (Upper)
#endif
#ifndef MCCONF_L_RPM_MIN
#define MCCONF_L_RPM_MIN				-30000.0	// The motor speed limit (Lower)
#endif
...
#define MCCONF_L_CURR_MAX_RPM_FBRAKE	90		// Maximum electrical RPM to use full brake at
#endif
...
#define MCCONF_L_LIM_TEMP_MOTOR_START	95.0	// MOTOR temperature where current limiting should begin
#endif
...
#define MCCONF_L_WATT_MAX				1500000.0	// Maximum wattage output  瓦数
#endif
...
#define MCCONF_FOC_CURRENT_KP			0.0592
#endif
...
#define MCCONF_FOC_MOTOR_L				0.00007
#endif
#ifndef MCCONF_FOC_MOTOR_R
#define MCCONF_FOC_MOTOR_R				0.034
#endif
#ifndef MCCONF_FOC_MOTOR_FLUX_LINKAGE
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	0.01563
#endif
#ifndef MCCONF_FOC_MOTOR_LD_LQ_DIFF
#define MCCONF_FOC_MOTOR_LD_LQ_DIFF		0.0
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN
#define MCCONF_FOC_OBSERVER_GAIN		4.1e6		// Can be something like 600 / L
#endif
...
#define MCCONF_FOC_SL_OPENLOOP_TIME		0.2	// Time to remain in openloop after ramping (s)
#endif
...
#define MCCONF_FOC_SL_OPENLOOP_T_LOCK	0.5		// Time to lock motor in beginning of open loop sequence
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_T_RAMP
#define MCCONF_FOC_SL_OPENLOOP_T_RAMP	0.5		// Time to ramp up motor to openloop speed
#endif
...
#define MCCONF_FOC_CC_DECOUPLING		FOC_CC_DECOUPLING_DISABLED // Current controller decoupling电流控制器解耦
#endif
...
#define MCCONF_FOC_OFFSETS_CURRENT_0	2042.8 // Current 0 offset
#endif
#ifndef MCCONF_FOC_OFFSETS_CURRENT_1
#define MCCONF_FOC_OFFSETS_CURRENT_1	2042.7 // Current 1 offset
#endif
#ifndef MCCONF_FOC_OFFSETS_CURRENT_2
#define MCCONF_FOC_OFFSETS_CURRENT_2	2042.4 // Current 2 offset
#endif
