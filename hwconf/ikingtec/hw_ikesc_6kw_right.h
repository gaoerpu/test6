...
#ifndef HW_IKESC_6kw_RIGHT_H_
#define HW_IKESC_6kw_RIGHT_H_

//hardware version


#define HW_NAME					"IKESC_6kw_RIGHT" PRODUCT_VERSION_SUFFIX
...
#define APPCONF_CONTROLLER_ID  21       //CAN ID识别号    
