...
#ifndef HW_IKESC20kw_LEFT_H_
#define HW_IKESC20kw_LEFT_H_

//hardware version


#define HW_NAME					"IKESC_20kw_LEFT" PRODUCT_VERSION_SUFFIX
...
#define APPCONF_CONTROLLER_ID  10   //CAN ID识别号
