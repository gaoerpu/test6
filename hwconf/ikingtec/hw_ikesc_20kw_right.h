...
#ifndef HW_IKESC20kw_RIGHT_H_
#define HW_IKESC20kw_RIGHT_H_

//hardware version


#define HW_NAME					"IKESC_20kw_RIGHT" PRODUCT_VERSION_SUFFIX

// HW properties
#define HW_HAS_3_SHUNTS
//#define HW_HAS_PHASE_SHUNTS       //相位分流采样   要开这个，硬件上必须是要电流采样独立布局，低端采样都是同时接地的
...
//IKESC 75_300 添加phase filtering功能。 
...
//IKESC 75_300 在2023年11月添加了phase filtering和current filtering。
...
#define MCCONF_L_IN_CURRENT_MAX			300.0	// Input current limit in Amperes (Upper) - 升级到300A
#endif
...
// Setting limits
#define HW_LIM_CURRENT			-300.0, 300.0  // ±300A
#define HW_LIM_CURRENT_IN		-280.0, 280.0 
#define HW_LIM_CURRENT_ABS		0.0, 360  // 峰值450A
#define HW_LIM_VIN			    12.0, 90.0  // 扩展到120V
...
#define APPCONF_CONTROLLER_ID  11     //CAN ID识别号


// HW-specific functions
bool hw_sample_shutdown_button(void);

#endif /* HW_IKESC_20kw_RIGHT_H_ */
