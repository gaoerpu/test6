...
//we do not recommend turning on the current filtering function, so it is set to off here.2023年11月的当前过滤。但由于是低端采样，
//我们不建议打开当前的过滤功能，因此此处将其设置为关闭。  官方原理图用的是高端采样
...
//The voltage dividing acquisition circuit on the Makerbase VESC motherboard is 560K and 21.5K resistors.VESC主板上的分压采集电路是560K和21.5K电阻器。
#ifndef VIN_R1
