...
package_dict["IKESC_6kw_LEFT"] = [['ikesc_6kw_left', default_name],  # 默认版，FOC 限值启用
                    ['ikesc_6kw_no_limits', no_limits_name]]  # 无限值版，测试高负载用
package_dict["IKESC_6KW_RIGHT"] = [['ikesc_6kw_right', default_name]]                    
package_dict["IKESC_20kw_RIGHT"] = [['ikesc_20kw_right', default_name],  # 默认版，FOC 限值启用
                    ['ikesc_20kw_right_no_limits', no_limits_name]]  # 无限值版，测试高负载用
package_dict["IKESC_20KW_LEFT"] = [['ikesc_20kw_left', default_name]]                
