...
typedef enum {
	...
	ADC_CTRL_TYPE_CURRENT_REV_CENTER,	//中心映射（带反转，支持双向油门）
...
typedef enum {
	...
	CAN_PACKET_STATUS_7                     = 69,    // 自定义状态7：转速、电流、电压、MOSFET 温度
	CAN_PACKET_GET_PRODUCT_INFO             = 100,    //定义一个特定的ID，专门用来查询产品版本 Information
